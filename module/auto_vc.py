    ...
    async def on_raw_reaction_add(self, payload :discord.RawReactionActionEvent):
        ...
        if str(payload.emoji) == "✏":
            ...
            if len(msg.content) > 0:
                ...
                vc = await self.bot.get_channel(yonosumi_utils.get_topic(channel, splited=True)[1])
            ...
            if not num > 100:
                vc: discord.VoiceChannel = await self.bot.get_channel(yonosumi_utils.get_topic(channel, splited=True)[1])
